...
export type GetLoggedInCustomerQuery = { __typename?: 'Query' } & {
  customer?: Maybe<
    { __typename?: 'Customer' } & Pick<
      ...
      | 'attributeCount'
    > & {
        storeCredit: Array<{ __typename?: 'Money' } & Pick<Money, 'value' | 'currencyCode'>>;
      }
  >;
};
...
export type CategoryTreeItemFragment = {
  __typename?: 'CategoryTreeItem';
} & Pick<CategoryTreeItem, 'entityId' | 'name' | 'path' | 'description' | 'productCount'>;

export type ProductPricesFragment = { __typename?: 'Prices' } & {
  price: { __typename?: 'Money' } & Pick<Money, 'value' | 'currencyCode'>;
  salePrice?: Maybe<{ __typename?: 'Money' } & Pick<Money, 'value' | 'currencyCode'>>;
  retailPrice?: Maybe<{ __typename?: 'Money' } & Pick<Money, 'value' | 'currencyCode'>>;
};
          ...
          { __typename?: 'ProductOptionValueEdge' } & {
            node:
              ...
              | ({ __typename?: 'ProductPickListOptionValue' } & Pick<
                  ...
                  'label'
                >)
              | ({ __typename?: 'SwatchOptionValue' } & Pick<SwatchOptionValue, 'label'> &
    ...
    images: { __typename?: 'ImageConnection' } & {
      edges?: Maybe<
        Array<
          Maybe<
            { __typename?: 'ImageEdge' } & {
              node: { __typename?: 'Image' } & Pick<Image, 'urlOriginal' | 'altText' | 'isDefault'>;
            }
          >
        >
      >;
          ...
          Maybe<
            { __typename?: 'VariantEdge' } & {
              node: { __typename?: 'Variant' } & Pick<Variant, 'entityId'> & {
                  defaultImage?: Maybe<
                    { __typename?: 'Image' } & Pick<Image, 'urlOriginal' | 'altText' | 'isDefault'>
                  >;
                };
            }
          >
    ...
    localeMeta: { __typename?: 'MetafieldConnection' } & {
      edges?: Maybe<
        Array<
          Maybe<
            { __typename?: 'MetafieldEdge' } & {
              node: { __typename?: 'Metafields' } & Pick<Metafields, 'key' | 'value'>;
            }
          >
        >
      >;
                                ...
                                Maybe<
                                  { __typename?: 'ProductOptionEdge' } & {
                                    node:
                                      | ({
                                          __typename: 'CheckboxOption';
                                        } & Pick<CheckboxOption, 'entityId' | 'displayName'>)
                                      | ({
                                          __typename: 'DateFieldOption';
                                        } & Pick<DateFieldOption, 'entityId' | 'displayName'>)
                                      | ({
                                          __typename: 'FileUploadFieldOption';
                                        } & Pick<FileUploadFieldOption, 'entityId' | 'displayName'>)
                                      | ({
                                          __typename: 'MultiLineTextFieldOption';
                                        } & Pick<
                                          MultiLineTextFieldOption,
                                      ...
                                      | ({
                                          __typename: 'MultipleChoiceOption';
                                        } & Pick<MultipleChoiceOption, 'entityId' | 'displayName'> &
                                          MultipleChoiceOptionFragment)
                                      | ({
                                          __typename: 'NumberFieldOption';
                                        } & Pick<NumberFieldOption, 'entityId' | 'displayName'>)
                                      | ({
                                          __typename: 'TextFieldOption';
  ...
  site: { __typename?: 'Site' } & {
    categoryTree: Array<
      { __typename?: 'CategoryTreeItem' } & {
        children: Array<
          { __typename?: 'CategoryTreeItem' } & {
            children: Array<{ __typename?: 'CategoryTreeItem' } & CategoryTreeItemFragment>;
        ...
        Array<
          Maybe<
            { __typename?: 'BrandEdge' } & Pick<BrandEdge, 'cursor'> & {
                ...
                > & {
                    defaultImage?: Maybe<
                      { __typename?: 'Image' } & Pick<Image, 'urlOriginal' | 'altText'>
                    >;
                  };
              }
          >
